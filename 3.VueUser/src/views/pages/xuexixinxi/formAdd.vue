	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"0px","background":"#fff","width":"86%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				...
				<el-col :span="8">
					<el-form-item label="学生时间" prop="xueshengshijian">
						<el-date-picker
							class="list_date"
							v-model="form.xueshengshijian"
							format="YYYY-MM-DD HH:mm:ss"
							value-format="YYYY-MM-DD HH:mm:ss"
							type="datetime"
							style="width:100%;"
							:readonly="!isAdd||disabledForm.xueshengshijian?true:false"
							placeholder="请选择学生时间" />
					</el-form-item>
				</el-col>
				<el-col :span="8">
...
<script setup>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
			form.value.xueshengshijian = context?.$toolUtil.getCurDateTime()
		if(formId){
			id.value = formId
			type.value = formType
		}
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='xueshengshijian'){
					form.value.xueshengshijian = row[x];
					disabledForm.value.xueshengshijian = true;
					continue;
				}
