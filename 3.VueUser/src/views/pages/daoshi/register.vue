	...
	<div>
		<div class="register_view">
			...
			<el-form :model="registerForm" class="register_form">
				<div class="list_item">
					<div class="list_label">导师账号：</div>
					<input class="list_inp"
					 v-model="registerForm.daoshizhanghao" 
					 placeholder="请输入导师账号"
					 type="text"
					 />
				</div>
				...
				<div class="list_item">
					<div class="list_label">导师姓名：</div>
					<input class="list_inp"
					 v-model="registerForm.daoshixingming" 
					 placeholder="请输入导师姓名"
					 type="text"
					 />
				</div>
...
<script setup>
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.daoshizhanghao)){
