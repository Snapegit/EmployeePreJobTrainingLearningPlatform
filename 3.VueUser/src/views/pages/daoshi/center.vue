<template>
	<div class="app-contain" :style='{"width":"86%","padding":"0","margin":"30px auto 50px","position":"relative","borderRadius":"0px","background":"none"}'>
		...
		<div class="usersView">
			...
			<div class="usersBox" v-if="tabIndex=='center'">
				<el-form class="usersForm" ref="userFormRef" :model="userForm" label-width="120px" :rules="rules">
					<el-row>
						<el-col :span="8">
							<el-form-item prop="daoshizhanghao" label="导师账号">
								<el-input class="list_inp" v-model="userForm.daoshizhanghao" placeholder="导师账号" readonly></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="8">
						...
						<el-col :span="8">
							<el-form-item prop="daoshixingming" label="导师姓名">
								<el-input class="list_inp" v-model="userForm.daoshixingming" placeholder="导师姓名" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
...
<script setup>
	...
	const getSession = () =>{
		context?.$http({
			...
			context?.$toolUtil.storageSet("frontName", res.data.data.daoshizhanghao)
