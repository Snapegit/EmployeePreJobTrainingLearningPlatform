<template>
	<div class="app-contain" :style='{"padding":"0px 0","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"86%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">学习进度</div>
					<div  class="info_text" >{{detail.xuexijindu}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">学习内容</div>
					<div  class="info_text" >{{detail.xuexineirong}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">更新时间</div>
					<div  class="info_text" >{{detail.gengxinshijian}}</div>
				</div>
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'点评')" @click="jihuadianpingonAcross('点评','jihuadianping','','','')" type="warning">点评</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('jihuajindu','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('jihuajindu','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
...
<script setup>
	...
	const jihuadianpingonAcross = (btnType,table,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
	...
	.detail_view{
		...
		.info_view {
			...
			.btn_view {
				...
				// 跨表-按钮
				.cross_btn {
					border: 1px solid rgba(170, 0, 0, 1.0);
					padding: 0 10px;
