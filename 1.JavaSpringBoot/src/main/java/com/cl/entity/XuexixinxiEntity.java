...
public class XuexixinxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public XuexixinxiEntity() {
		
	}
	
	public XuexixinxiEntity(T t) {
		try {
	 ...
	 * 设置：学生时间
	 */
	public void setXueshengshijian(Date xueshengshijian) {
		this.xueshengshijian = xueshengshijian;
	}
	/**
	 * 获取：学生时间
	 */
	public Date getXueshengshijian() {
		return xueshengshijian;
	}
	/**
	 * 设置：员工工号
	 */
