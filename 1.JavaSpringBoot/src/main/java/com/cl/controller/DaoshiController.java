...
public class DaoshiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		DaoshiEntity u = daoshiService.selectOne(new EntityWrapper<DaoshiEntity>().eq("daoshizhanghao", username));
        if(u==null || !u.getMima().equals(password)) {
            return R.error("账号或密码不正确");
        }
		String token = tokenService.generateToken(u.getId(), username,"daoshi",  "管理员" );
    ...
    public R register(@RequestBody DaoshiEntity daoshi){
    	...
    	DaoshiEntity u = daoshiService.selectOne(new EntityWrapper<DaoshiEntity>().eq("daoshizhanghao", daoshi.getDaoshizhanghao()));
		if(u!=null) {
    ...
    public R info(@PathVariable("id") Long id){
		...
		daoshi = daoshiService.selectView(new EntityWrapper<DaoshiEntity>().eq("id", id));
