				...
				<el-row>
					<el-col :span="24">
						<el-form-item label="导师账号" prop="daoshizhanghao">
							<el-input class="list_inp" v-model="user.daoshizhanghao" readonly placeholder="导师账号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="导师姓名" prop="daoshixingming">
							<el-input class="list_inp" v-model="user.daoshixingming"  placeholder="导师姓名" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="头像" prop="touxiang">
							<uploads
								...
								@change="daoshitouxiangUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="24">
...
<script setup>
	...
	const daoshitouxiangUploadSuccess=(fileUrls)=> {
	    user.value.touxiang = fileUrls;
	}
	const onSubmit = () => {
		if((!user.value.daoshizhanghao)){
			context?.$toolUtil.message(`导师账号不能为空`,'error')
			return false
		}
		if((!user.value.mima)){
